...
def delete_existing_records_for_subdomain(cf_token, zone_id, subdomain_name, reverse_domain):
    ...
    try:
        ...
        if result.get("success"):
            ...
            if deleted_count > 0:
                print(f"🗑️ 已删除 {record_name} 的 {deleted_count} 条旧记录")
...
def upload_ips_to_cf(input_dir="valid_proxies", reverse_domain="5.a.9.f.0.7.4.0.1.0.0.2.ip6.arpa", cf_token=None, zone_id=None, max_ips_per_file=30):
    """
